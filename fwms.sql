...
(17, 'BOYS_DINING', '2021-03-01', 'mon', 'breakfast', 'COOK_ITEM_WASTE', 2.00, 'super@admin.in', '2021-04-11 20:48:26');
...
CREATE TABLE `institutions` (
  ...
  `institution_city` varchar(30) NOT NULL,
  `institution_state` varchar(30) NOT NULL,
  `institution_pincode` varchar(6) NOT NULL,
  `institution_email` varchar(50) NOT NULL,
  `institution_phone` varchar(10) NOT NULL,
  `institution_registered_at` datetime NOT NULL DEFAULT current_timestamp()
...
INSERT INTO `institutions` (`institution_id`, `institution_name`, `institution_address`, `institution_city`, `institution_state`, `institution_pincode`, `institution_email`, `institution_phone`, `institution_registered_at`) VALUES
(1, 'M. Kumarasamy college of engineering', '12, National salem highways, near thalavapalayam', 'Karur', 'Tamil Nadu', '612345', 'mkce@gmail.com', '9987654321', '2021-04-17 18:46:40');
...
CREATE TABLE `orphanages` (
  ...
  `orphanage_address` varchar(150) NOT NULL,
  `orphanage_city` varchar(30) NOT NULL,
  `orphanage_state` varchar(30) NOT NULL,
  `orphanage_pincode` varchar(6) NOT NULL,
  `orphanage_email` varchar(50) NOT NULL,
  `orphanage_phone` varchar(10) NOT NULL,
  `orphanage_registered_at` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `orphanages` (`orphanage_id`, `orphanage_name`, `orphanage_address`, `orphanage_city`, `orphanage_state`, `orphanage_pincode`, `orphanage_email`, `orphanage_phone`, `orphanage_registered_at`) VALUES
(1, 'Annai theressa orphanage', '123, R.V Nagar', 'Karur', 'Tamil Nadu', '654321', 'at.orphanage@gmail.com', '9876543210', '2021-04-17 18:20:35');
...
('bhuvi@gmail.com', 'bhuvi', '$2y$10$VGhpcyNJcyNNeSNIYXNoaO4m9T/GSTunGfgUtnD5cSHdd7M8TDgzS', 'MANAGER', 'BOYS_DINING', '2021-01-24 21:04:03', 1, 1),
...
(40, 'bhuvi@gmail.com', 0, 'super@admin.in', '2021-04-12 22:20:18');
...
--
ALTER TABLE `orphanages`
  MODIFY `orphanage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
